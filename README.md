...
Production-ready deployment of OpenEMR 8.x and higher on Red Hat's OpenShift Developer Sandbox using a custom CentOS 10 Stream container with PHP 8.5 from Remi's repository.
